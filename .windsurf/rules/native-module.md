...
- **Limits:** Max recording duration: 4 hours. Max file size: ~500MB (to ensure RAM safety during decryption).

## 3. Isomorphic Implementation Strategy
...
- **Testing:** Every iOS test case (e.g. `testCorruptedChunk`) must have an exact equivalent in Android.