 ...
 *
 * ## Who calls it
 * - **@Entity** (Database/Entity.ts): in its `fn`, calls `MetadataWriter.registerEntity(target, options)`.
...
export class MetadataWriter {
    ...
    public static registerEntity(construct: Function, options: { table_name: string }): void {
